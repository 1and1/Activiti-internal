 ...
 * 
 */
public class ProcessInstanceActivateExecutionResource extends SecuredResource {

	@Post
	public ObjectNode activateProcessInstance() {
		try {
			...
			ActivitiUtil.getRuntimeService().activateProcessInstanceById(
					processInstanceId);
			...
			throw new ActivitiException("Failed to activate process instance",
					e);
		}
